...
int main(void)
{
	...
	glGenBuffers(1, &hBuffer);				// Generate vertex buffer ID
    ...
    glGenBuffers(1, &ibo);                      // Generate index buffer ID
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, ibo); // Assign buffer type Array
